/**
 * @module WayfindingPanel
 * @description AI-powered wayfinding panel with step-by-step navigation.
 * Provides optimal route from current location to assigned seat.
 *
 * Architecture: Uses PanelShell for consistent layout with cyan accent theme.
 *
 * Hackathon Alignment:
 * - AI route optimization avoiding congested areas
 * - Step-by-step turn-by-turn navigation instructions
 * - Real-time gate queue avoidance
 * - Distance and time estimation for fan experience
 */
...
export default memo(function WayfindingPanel() {
  return (
    <PanelShell
      ariaLabel="AI wayfinding navigation"
      header={
        <>
          <div>
            <h2 className="text-[13px] font-semibold text-white/90 flex items-center gap-2"><Navigation className="w-3.5 h-3.5 text-cyan-400" /> AI Wayfinding</h2>
            <p className="text-[10px] text-white/25 mt-0.5">Gate S → Section 112</p>
          </div>
